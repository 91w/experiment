...
//import org.wgh.handshop.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson2.JSONObject;
import org.wgh.handshop.entity.*;
import org.wgh.handshop.service.*;
import org.wgh.handshop.util.KeyUtil;
import org.wgh.handshop.util.StatusCode;
import org.wgh.handshop.vo.LayuiPageVo;
import org.wgh.handshop.vo.PageVo;
...
public class CommodityController {
    ...
    public String relgoods(@RequestBody Commodity commodity, HttpSession session){
        ...
        commodity.setCommid(commid).setUserid(userid).setAddress(userInfo.getAddress());//商品id
        commodity.setCommon(commodity.getCommon()+"、"+commodity.getCommon2());//常用选项拼接
