...
import org.wgh.handshop.service.CollectService;
import org.wgh.handshop.util.GetDate;
    ...
    public ResultVo insertcollect(@RequestBody Collect collect, HttpSession session){
        ...
        if (colloperate == 1){
            ...
            if(!StringUtils.isEmpty(collect1)){
                /**更改原来的收藏信息和状态*/
                collect1.setCommname(collect.getCommname()).setCommdesc(collect.getCommdesc()).setAddress(collect.getAddress())
